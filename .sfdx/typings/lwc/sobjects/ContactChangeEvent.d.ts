...
declare module "@salesforce/schema/ContactChangeEvent.ContactSource" {
...
declare module "@salesforce/schema/ContactChangeEvent.et4ae5__HasOptedOutOfMobile__c" {
  const et4ae5__HasOptedOutOfMobile__c:boolean;
  export default et4ae5__HasOptedOutOfMobile__c;
}
declare module "@salesforce/schema/ContactChangeEvent.et4ae5__Mobile_Country_Code__c" {
  const et4ae5__Mobile_Country_Code__c:string;
  export default et4ae5__Mobile_Country_Code__c;
}
declare module "@salesforce/schema/ContactChangeEvent.related_Opportunity__c" {
  const related_Opportunity__c:any;
  export default related_Opportunity__c;
}
