...
declare module "@salesforce/schema/Contact.related_Opportunity__r" {
  const related_Opportunity__r:any;
  export default related_Opportunity__r;
}
declare module "@salesforce/schema/Contact.related_Opportunity__c" {
