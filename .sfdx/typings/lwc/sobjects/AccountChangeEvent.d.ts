...
declare module "@salesforce/schema/AccountChangeEvent.OperatingHours" {
  const OperatingHours:any;
  export default OperatingHours;
}
declare module "@salesforce/schema/AccountChangeEvent.OperatingHoursId" {
...
declare module "@salesforce/schema/AccountChangeEvent.Contact_Available__c" {
  const Contact_Available__c:boolean;
  export default Contact_Available__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Needs_Follow_Up__c" {
  const Needs_Follow_Up__c:boolean;
  export default Needs_Follow_Up__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Email__c" {
  const Email__c:string;
  export default Email__c;
}
declare module "@salesforce/schema/AccountChangeEvent.Ultimate_Parent__c" {
  const Ultimate_Parent__c:string;
  export default Ultimate_Parent__c;
}
