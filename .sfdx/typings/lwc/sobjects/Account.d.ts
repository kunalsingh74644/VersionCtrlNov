...
declare module "@salesforce/schema/Account.Contact_Available__c" {
  const Contact_Available__c:boolean;
  export default Contact_Available__c;
}
declare module "@salesforce/schema/Account.Needs_Follow_Up__c" {
...
declare module "@salesforce/schema/Account.Ultimate_Parent__c" {
